...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(240, 101, "end", "include/csr_util.stan");
    reader.add_event(240, 3, "restart", "model_bounded");
    reader.add_event(240, 3, "include", "include/r_type_prob.stan");
    ...
    reader.add_event(1427, 1113, "end", "model_bounded");
    return reader;
}
int
